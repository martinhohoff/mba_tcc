...
\chapter[Metodologia]{Metodologia}
    ...
    \section[Desenvolvimento]{Desenvolvimento}
        ...
        \subsection{Atividades realizadas}
            ...
            O mesmo processo foi aplicado nas colunas 'spoken\_languages' e 'original\_language', mas levando em consideração todas as linguagens existentes na tabela. Após convertidas em colunas de hot encoding no formato 'original\_language\_XX' e 'spoken\_language\_XX', as colunas originais também foi removida após esse processo.
            ...
            Foram localizados também 6 filmes com valores float (NaN) na coluna 'title'. Nesses casos, o título original foi transposto para a coluna title. Nesse processo, foram localizados também três filmes com valores espúrios no título:
