...
\chapter[Metodologia]{Metodologia}
    ...
    \section[Desenvolvimento]{Desenvolvimento}
        ...
        \subsection{Atividades realizadas}
            ...
            O passo seguinte é adicionar as informações de premiação ao dataset principal a ser analisado. Consideramos que um filme é o mesmo nos dois datasets caso seu nome e ano de lançamento seja o mesmo nas duas tabelas.

            Mas para fazer essa união entre as duas tabelas, foi também necessário normalizar nomes nas duas tabelas. Alguns dos desafios encontrados nesse estágio foram:
            ...
            Após essas etapas, já é possível relacionar entre as tabelas 620 dos 939 filmes no dataset do Oscar. Mas dois desafios especiais se deram por conta de:\par
            ...
            - títulos divergentes entre as duas tabelas (como "Mt. Head" na tabela do Oscar, que consta como "Mount head" na tabela de metadados de filmes).\par
            Para esses casos, foi realizada uma análise de similaridade entre os títulos não encontrados nas duas tabelas, utilizando a biblioteca nativa difflib do Python, e uma análise caso a caso. Foram encontrados\newline
            - Filmes com anos de lançamento divergente entre os datasets (por exemplo, data de lançamento
            ...
            Para isso, vamos ver se todos os filmes do dataset dos Oscars estão contidos no dataset The Movies Dataset, e criar colunas no formato one-hot encoding para inserir as informações de nomeação e vitória em cada categoria para cada filme.
