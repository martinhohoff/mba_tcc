...
\chapter[Metodologia]{Metodologia}
    ...
    \section{Fundamentos}
	    ...
	    Entre os algoritmos de classificação e regressão, podemos destacar:\newline
    ...
    \section[Desenvolvimento]{Desenvolvimento}
        ...
        \subsection{Atividades realizadas}
            ...
            Foi analisada a possibilidade de remoção de outliers nos atributos numéricos ('budget', 'popularity', 'revenue', 'runtime', 'vote\_average', 'vote\_count' e 'release\_day').
