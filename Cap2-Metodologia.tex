...
\chapter[Metodologia]{Metodologia}
    ...
    \section[Desenvolvimento]{Desenvolvimento}
        ...
        \subsection{Atividades realizadas}
            ...
            O passo seguinte é adicionar as informações de premiação ao dataset principal a ser analisado. Para isso, vamos ver se todos os filmes do dataset dos Oscars estão contidos no dataset The Movies Dataset.
