...
\chapter[Metodologia]{Metodologia}
    ...
    \section[Desenvolvimento]{Desenvolvimento}
        ...
        \subsection{Atividades realizadas}
            ...
            Por fim, alguns tratamentos simples:
            \begin{itemize}
                \item a coluna 'adult', que indica se um filme é adulto, é convertida para booleano;
                \item a coluna 'budget' é transformada em float.\newline
            \end{itemize}
