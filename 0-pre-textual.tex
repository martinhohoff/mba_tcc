...
\titulo{Estudo e Implementação de Modelos para Anotação Celular a partir de Dados de \textit{Single-Cell RNA-seq}}
\titleabstract{Study and Implementations of Models to Cell Type Annotation from Single-Cell RNA-Seq Data}
...
\autor{Ana Elisa Ribeiro Orsi}
\autorficha{Orsi, Ana Elisa Ribeiro}
\autorabr{ORSI, A. E. R.}
...
\orientador{Profa. Dra. Gleice da Silva Castro Perdoná}
\orientadorcorpoficha{orientadora Gleice da Silva Castro Perdoná}
\orientadorficha{Perdoná, Gleice da Silva Castro, orient}
