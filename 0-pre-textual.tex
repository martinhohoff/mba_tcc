...
\titulo{Redes neurais aplicadas à previsão de premiações em metadados de cinema}
\titleabstract{Neural networks applied to predicting awards in cinema metadata}
